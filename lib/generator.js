 ...
 * @returns void
 */
const generatePageFrom = (source, elmcode, appjs, withDraft) => {
    try {
        // create flags
        const document = parseDocument(fs_1.default.readFileSync(source, 'utf-8'));
...
exports.default = generatePageFrom;
